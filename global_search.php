...
<div id="gs_series">
  <div class="wrap">
    ...
    <?php if(count($dataSeries) > 0) : ?>
      ...
      <div class="gs_row">
        <div class="gs_image">
          <a href="#"><p><span class="gs_text_img"><?php echo $series['short_description']; ?></span></p><img src="images/<?php echo $series['image']; ?>" height="200px" width="150px"></a>
        </div>
...
<div id="gs_user">
  <div class="wrap">
    ...
    <?php foreach ($dataUsers as $user) : ?>
      <div class="gs_row">
        <div class="gs_image">
          <a href="#"><img src="images/<?php echo $user['avatar']; ?>" height="150px" width="150px"></a>
        </div>
        <div class="gs_description">
