...
class TVShow{
     ...
     * 	@return int
     */
    public function getSeason($numSeason, $idTVShow) {
        ...
        return new Season($data, $idTVShow);
    }
    ...
    /**
     * 	Get the TVShow's original country
     *
     * 	@return int
     */
    public function getOriginalCountry() {
      if($this->_data['origin_country'] == null) {
         return "N/A";
      }
      else if(isset($this->_data['origin_country'][0])) {
         return $this->_data['origin_country'][0];
      }
      else {
    ...
    */
    public function getKeywords(){
      return $this->_data['keywords']['results'];
    }

    /**
    * 	Get TVShow's first keyword
    *
    * 	@param int $idTVShow The TVShow id
    * 	@param string $appendToResponse The extra append of the request, by default all
    * 	@return TVShow
    */
    public function getKeyword(){
      return $this->_data['keywords']['results'][0]['id'];
    }

    /**
     * 	Get the TVShow last air date
     *
     * 	@return boolean
     */
