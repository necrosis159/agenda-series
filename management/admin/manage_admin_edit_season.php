...
<div class="wrap">
   <section id="manage">
      ...
      <a class="button" href="manage_admin_seasons.php?id=<?php echo $data['id_serie']; ?>">Retour à la liste des saisons</a> <p align="right"><a class="button" href="#">Ajouter un épisode</a>  &nbsp; <a class="button" href="manage_admin_episodes.php?id=<?php echo $id; ?>">Modifier un épisode</a> &nbsp;</p>
