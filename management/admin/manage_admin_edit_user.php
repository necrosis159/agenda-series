<?php
   ...
   elseif(isset($_POST['submit_remove'])) {
      ...
      header('Location: manage_admin_users.php?delete=true');
         ...
         <div>
            <label>Genre
               <select name="gender" onchange="updated(this)" autofocus="">
                     <option value="0" <?php if($data['gender'] == 0) { echo "selected"; } ?>>Homme</option>
                     <option value="1" <?php if($data['gender'] == 1) { echo "selected"; } ?>>Femme</option>
               </select>
            </label>
         </div>
