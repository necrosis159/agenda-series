...
<div id="serie_detail">
		<div id="containerSerie">
			...
			<div id="divRightSerie">
				...
				<div id='subtitle'>
					<?php echo "Nombres d'épisode: ".$season_result[0]->getNbepisode()."<br>";
				...
				<ul class="list_episode">
					<?php 
						...
						foreach ($liste_episode as $value) {
							...
							echo '
								<li>
									<div id="name_episode"> <a href="/serie/'.$id_serie.'/Saison'.$number_season.'/Episode'.$value->getNumber().'">Episode '.$value->getNumber().'</a> <span style="float: right;">'.$value->getAirDate().'</span></div>
