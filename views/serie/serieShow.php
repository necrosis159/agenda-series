	...
	<div id="serie_detail">
		<div id="containerSerie">
			...
			<table class="heavyTable">
				<thead>
               <tr>
                  <th class="th_small">Numéro de la série</th>
                                       <th>Titre</th>
                                       <th>Nombre d'épisode</th>
                  <th class="th_small">Voir la saison</th>
               </tr>
            </thead>
            ...
            <tbody id="result_table">
                     ...
                     <td><?php echo $value->getNbEpisode()?></td>
                     <td><?php echo '<a href="/serie/'.$id_serie.'/Saison'.$value->getNumber().'">Voir la saison</a>'; ?></td>
                  </tr>
             </tbody>
             <?php } ?>
			</table>
