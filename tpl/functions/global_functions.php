<?php
   ...
   function call_pdo() {
     try {
       $db = new PDO('mysql:host=localhost;dbname=agendaseltserie;charset=utf8', 'root', '', array(PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
     } catch (Exception $e) {
   ...
   // Requête de recupération d'un id a partir de username
