...
class baseModels {
    ...
    public function __construct() {
        try {
            $this->pdo = new PDO('mysql:host=agendaseltserie.mysql.db;dbname=agendaseltserie;charset=utf8', 'agendaseltserie', 'yUzuP2ebraha', array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES utf8"));
