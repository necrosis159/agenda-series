            ...
            if(count($result) > 0) {
               ...
               for($i = 0; $i < count($result); $i++) {
                  ...
                  if($result[$i]['episode_air_date'] == $this->currentDate) {
                     $cellIDTVShow .= '&squarf; <a href="/serie/' . $result[$i]['serie_id'] . '/Saison' . $result[$i]['season_number'] . '/Episode' . $result[$i]['episode_number'] . '" title="' . $result[$i]['serie_name'] . " : Saison " . $result[$i]['season_number'] . " - Episode " . $result[$i]['episode_number'] . '">' . $result[$i]['serie_name'] . ' : S' . $result[$i]['season_number'] . 'E' . $result[$i]['episode_number'] . '</a><br>';
                  }
               }
            }
            else {
